    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16">
        <h1 className="text-5xl md:text-6xl font-bold mb-6">
          ...
          <span className="text-yellow-400 block mt-2">Vinayak Santhosh</span>
        </h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-20">
        <div>
          <h2 className="text-2xl font-bold mb-6 text-yellow-400">About Me</h2>
      ...
      {/* Skills */}
      <div className="mb-20">
        <h2 className="text-2xl font-bold mb-8 text-yellow-400 text-center">Technical Skills</h2>
        <div className="flex flex-wrap justify-center gap-3">
          {skills.map((skill, index) => (
            <span 
              key={index}
              className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full hover:bg-yellow-400 hover:text-black transition-colors"
            >
              {skill}
            </span>
          ))}
      ...
      <div className="text-center">
        <div className="flex justify-center space-x-8 mb-8">
          <a href="https://github.com/knaaps" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-yellow-400">
            GitHub
          </a>
          <a href="https://linkedin.com/in/vinayak-s-937b9126a" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-yellow-400">
            LinkedIn
          </a>
          <a href="mailto:vinayak4x@gmail.com" className="text-gray-400 hover:text-yellow-400">
            Email
          </a>
        </div>
      </div>
